        ...
        <div className="w-full max-w-[1200px] flex flex-col gap-16 md:gap-24">
          ...
          <div className="grid grid-cols-3 gap-4 border-b border-black/10 pb-8 text-[9px] md:text-[11px] tracking-widest font-bold font-sans text-black/60">
            ...
            <div className="text-center leading-normal">
              CREATIVE, CURIOUS,<br />PROBLEM SOLVER
            </div>
            <div className="text-right leading-normal">
              TECH + COFFEE<br />LOVER ☕
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-center justify-center gap-12 font-sans font-bold text-center tracking-wide leading-[1.3] text-[20px] md:text-[34px] lg:text-[40px] uppercase text-[#1C1C1C]">
            <p className="max-w-[1000px]">
              HEY, I'M BANTY, A FULL STACK DEVELOPER AND BCA STUDENT PASSIONATE ABOUT BUILDING MODERN WEB APPLICATIONS.
            </p>
            <p className="max-w-[1000px]">
              I WORK WITH TECHNOLOGIES LIKE REACT, NODE.JS, EXPRESS, MONGODB, MYSQL, AND JAVASCRIPT TO CREATE FAST, RESPONSIVE, AND USER-FRIENDLY DIGITAL EXPERIENCES.
            </p>
            <p className="max-w-[1000px]">
              I ENJOY LEARNING NEW TOOLS, DEVELOPING CREATIVE SOLUTIONS, CONTRIBUTING TO REAL-WORLD PROJECTS, AND CONTINUOUSLY IMPROVING MY TECHNICAL SKILLS.
            </p>
            <p className="max-w-[1000px]">
              WHEN I'M NOT CODING, YOU'LL FIND ME EXPLORING NEW TECHNOLOGIES, WATCHING TECH CONTENT, TRAVELING, OR ENJOYING GOOD FOOD.
            </p>
            <p className="max-w-[1000px]">
              ...
              <a
                ...
                className="mt-4 inline-block lowercase font-extrabold text-black underline underline-offset-8 decoration-4 hover:opacity-80 transition-opacity"
              >
          ...
          <div className="w-full hidden justify-center items-center gap-12 md:gap-24 mt-8 md:mt-16 max-w-[800px] mx-auto">
            <motion.img
